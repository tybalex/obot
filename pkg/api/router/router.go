...
func Router(services *services.Services) (http.Handler, error) {
	...
	mux.HandleFunc("PUT /api/mcp-catalogs/{catalog_id}/servers/{mcp_server_id}", mcp.AdminOnlyUpdateServer)
	...
	mux.HandleFunc("GET /api/assistants/{assistant_id}/projects/{project_id}/mcpservers/{project_mcp_server_id}/check-oauth", projectMCP.CheckOAuth)
