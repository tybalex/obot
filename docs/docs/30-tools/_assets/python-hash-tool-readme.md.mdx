## Writing your first tool in Python {#writing-your-first-tool-in-python}
...
## Tool Repo Structure {#tool-repo-structure-python}
...
## Defining the `Hash` Tool {#defining-the-hash-tool-python}
...
## Tool Metadata {#tool-metadata-python}
...
## Implementing Business Logic {#implementing-business-logic-python}
...
## Testing `hash.py` Locally {#testing-hash-py-locally-python}
...
## Adding The `Hash` tool to Obot {#adding-the-hash-tool-to-obot-python}
...
## Using The `Hash` tool in an agent {#using-the-hash-tool-in-an-agent-python}
